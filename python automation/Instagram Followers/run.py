...
usr = input('His/Her Username =  ')
user_input = input('followers you want to scrape (60-500 recommanded) = ')
# ==========================================
...
def scrape(username):
    ...
    bot = webdriver.Chrome('/home/aadesh/Documents/PycharmProjects/chromedriver/chromedriver', options=options)
    ...
    username_field.send_keys('love_hyper_cars')
    ...
    bot.find_element_by_xpath('//*[@id="react-root"]/section/main/div/ul/li[2]/a').click()

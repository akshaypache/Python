...
cp = Tk()
cp.title('TECH IN SECONDS | QR CODE GENERATER')
# cp.geometry('700x250')
cp.config(bg='#e52165')
...
Label(frame, text='Enter the Text or URL : ',fg="white", font=('Arial Black', 16),bg='#e52165').grid(row=0, column=0, sticky='w')
...
Label(frame, text='File Name(Save As) : ',fg="white", font=('Arial Black', 16),bg='#e52165').grid(row=1, column=0, sticky='w')
